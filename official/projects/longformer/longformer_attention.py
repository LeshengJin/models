...
class LongformerAttention(tf.keras.layers.MultiHeadAttention):
  ...
  def call(self,
    ...
    #     [batch_size, seq_len, self._num_heads, self.head_dim],
    ...
    attn_output, global_attn_probs = tf.cond(
      ...
      lambda: (attn_output, tf.zeros((batch_size, self._num_heads, max_num_global_attn_indices, seq_len))),
    )
